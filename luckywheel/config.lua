...
Config.Prizes = {
    ...
    {name = "$10,000", money = 10000, weight = 4},
    {name = "$7,500", money = 7500, weight = 5},
    {name = "$5,000", money = 5000, weight = 6},
    {name = "$3,000", money = 3000, weight = 7},
    {name = "$2,000", money = 2000, weight = 8},
    {name = "$1,000", money = 1000, weight = 9},
